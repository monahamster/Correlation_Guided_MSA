...
# This code is adapted from the following implementation:
# https://github.com/lyh6560new/BotMoE/blob/main/moe_all.py
...
class MoE(nn.Module):
    ...
    # Add reliability bias to gating logits before noisy top-k.
