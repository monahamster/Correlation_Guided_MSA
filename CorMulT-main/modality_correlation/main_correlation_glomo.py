...
from glomo_dataset import GLoMoPKLDataset
...
def main():
    ...
    if args.pkl_path is None:
        args.pkl_path = os.path.join(repo_root, "datasets", f"{args.dataset}.pkl")
    ...
    dataset_name = "glomo_mosi" if args.dataset == "mosi" else "glomo_mosei"
